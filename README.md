...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/deepecho-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14601&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/deepecho-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `deepecho` can be installed with:

```
conda install deepecho
```

It is possible to list all of the versions of `deepecho` available on your platform with:
